...
sender_email = "dfnc.actor101@gmail.com"
receiver_email = "dfnc.actor101@gmail.com"
password = "wpxp fuxy rdwt bdid"  # Your app password

# Subjects for training (Gmail may flag these as spam)
subjects = [
...
bodies = [
    ...
    "You’re eligible for a free reward. Claim here: {link}",
...
for i in range(10):
    ...
    time.sleep(60)  # Wait 60 seconds before sending the next email
